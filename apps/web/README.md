...
- Workspace Studio now uses shared surface primitives for its shell, Clients and Lifecycle summary cards, Chart loading/error/empty states, and the Practice, Locations, and Lifecycle section layouts
